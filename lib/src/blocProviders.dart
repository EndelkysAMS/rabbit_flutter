...
List<BlocProvider> blocProviders = [
  BlocProvider<LoginBloc>(
      create: (context) =>
          LoginBloc(locator<AuthUseCases>(), locator<UsersUseCases>())
            ..add(LoginInitEvent())),
  ...
  BlocProvider<DriverMapLocationBloc>(
      create: (context) => DriverMapLocationBloc(
          ...
          locator<AuthUseCases>(),
          locator<DriversPositionUseCases>())),
  BlocProvider<DriverBikeInfoBloc>(
      create: (context) => DriverBikeInfoBloc(
          locator<AuthUseCases>(), locator<DriverBikeInfoUseCases>())),
  ...
  BlocProvider<DriverHistoryTripBloc>(
      create: (context) => DriverHistoryTripBloc(
          locator<ClientRequestsUseCases>(), locator<AuthUseCases>())),
